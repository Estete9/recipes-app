...
ActiveRecord::Schema[7.1].define(version: 2024_01_31_125840) do
  ...
  create_table "foods_inventories", id: false, force: :cascade do |t|
    ...
    t.index ["food_id", "inventory_id"], name: "index_foods_inventories_on_food_id_and_inventory_id", unique: true
